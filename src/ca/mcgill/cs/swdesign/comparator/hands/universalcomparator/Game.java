...
public class Game
{
    ...
    public static void main(String[] args){
        ...
        UniversalComparator descendingComparator = new UniversalComparator();
        descendingComparator.setMethod(UniversalComparator.compareMethod.DESCENDING);
        Collections.sort(g.getAllHands(), descendingComparator);
