package ca.mcgill.cs.swdesign.nullvalues.nullobject.strategycomparehand;
 ...
 * Create default null comparator
 */
...
public class Hand {
    ...
    private Comparator<Card> compareMethod = NULL_COMPARATOR;
